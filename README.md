...
* Translate raw data into useful statistics (e.g. duration of map played, players present during the map, and etc.).
...
* Filter for embeds without valid embedded map image and create a prioritised list of maps that require a map image to be made.
  - (Obsolete in CS2) Maps in this list are also unbound to map versions; e.g. data from *ze_map_v1* and *ze_map_v2* will be combined together into *ze_map* when calculating statistics.
